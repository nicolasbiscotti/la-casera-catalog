...
This project is indexed by GitNexus as **la-casera-catalog** (915 symbols, 1786 relationships, 70 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
