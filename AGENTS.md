...
This project is indexed by GitNexus as **la-casera-catalog** (793 symbols, 1647 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
